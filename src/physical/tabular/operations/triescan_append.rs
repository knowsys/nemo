                        ...
                        ($variant:ident, $type:ty) => {{
                                ...
                                referenced_column
                            {
                                ...
                                let new_interval_column =
                                    ColumnRle::range(0usize, 1usize, NonZeroUsize::new(prev_column.len()).expect("Tried to construct empty rle column."));
                    ...
                    macro_rules! append_columns_for_datatype {
                        ($value:ident, $variant:ident, $type:ty) => {{
                            let target_length = gap_index
                                ...
                                .unwrap_or(1);
                            let target_length = NonZeroUsize::new(target_length).expect("Tried to construct empty rle column.");

                            let new_data_column = ColumnRle::constant(
                                $value,
                                target_length,
                            );
                            let new_interval_column =
