...
use self::{
    double::{
        ...
        numeric_multiplication_double, numeric_negation_double, numeric_sin_double,
        numeric_squareroot_double, numeric_subtraction_double, numeric_tan_double, numeric_power_double,
    },
    float::{
        ...
        numeric_negation_float, numeric_sin_float, numeric_squareroot_float,
        numeric_subtraction_float, numeric_tan_float, numeric_power_float,
    },
    integer64::{
        ...
        numeric_multiplication_integer64, numeric_negation_integer64, numeric_squareroot_integer64,
        numeric_subtraction_integer64, numeric_power_integer64,
    },
};
