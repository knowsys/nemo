//! This module implements the numeric functions for [Double]s.
...
use crate::{
    ...
    storagevalues::double::Double,
};

use super::OperableNumeric;

impl OperableNumeric for Double {
    ...
    where
        Self: Sized,
    {
        let mut sum = Double::new_unchecked(0.0);
    ...
    where
        Self: Sized,
    {
        let mut product = Double::new_unchecked(1.0);
        ...
        Self: Sized,
    {
        ...
        let result = Double::new_unchecked(0.0)
