...
//!
//! This for example allows aggregating [`StorageTypeName:U64`] values, even tough this may not make sense on the logical layer,
//! where these values may correspond to dictionary entires in arbitrary order.
