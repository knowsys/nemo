...
pub mod old {
    //! FIXME: remove when new parser is in use and wasm binds can get updated
    use super::{iri, rfc5234, sparql, turtle};
    ...
    pub use super::types::{span_from_str, LocatedParseError, ParseError, ParseResult};
    use super::types::{ConstraintOperator, IntermediateResult, Span};
                            ...
                            alt((
                                ...
                                map(
                                    ...
                                    |(_endpoint, _projection, _query)| {
                                        Err(ParseError::UnsupportedSparqlSource(
                                            predicate.clone().0,
                                        ))
                                    },
                                ),
    ...
    mod test {
        ...
        fn parse_function_terms() {
            ...
            let nullary_function =
                Term::Function(Identifier(String::from("nullary_function")), vec![]);
            assert_parse!(
                parser.parse_function_term(),
                "nullary_function()",
                nullary_function
